...
class GoiTapSection extends StatefulWidget {
  const GoiTapSection({super.key});

  @override
  State<GoiTapSection> createState() => _GoiTapSectionState();
}

class _GoiTapSectionState extends State<GoiTapSection> {
  var rowsPerPage = 15;

  final source = GoiTapSource();
              ...
              DataCell(Row(
                children: [
                  IconButton(icon: const Icon(Icons.edit), onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => GoiTapForm(), settings: RouteSettings(
                        arguments: goitap
                    )));
                  },),
                  IconButton(icon: const Icon(Icons.delete), onPressed: (){
                    showDialog(context: context, builder: (BuildContext context){
                      return AlertDialog(
                        ...
                        content: Text("Bạn có chắc chắn muốn xóa gói tập này không", style: TextStyle(fontSize: 20),),
                        actions: [
  ...
  void navigateToForm(context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => const GoiTapForm(), settings: const RouteSettings(
      ...
      child: SingleChildScrollView(
        child: Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.center,children: [
            const Text("Gói Tập", style: TextStyle(fontSize: 25)),
            Container(
