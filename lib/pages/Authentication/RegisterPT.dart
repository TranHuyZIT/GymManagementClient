...
enum FormData { Name, Phone, Email, Gender, password, ConfirmPassword, Identity, DOB, HEIGHT, WEIGHT }

class SignupPTScreen extends StatefulWidget {
  @override
  State<SignupPTScreen> createState() => _SignupPTScreenState();
}

class _SignupPTScreenState extends State<SignupPTScreen> {
  ...
  void submit() async{
    var jsonResponse = await PTService.add({
      "user": {
      ...
      "nv": {
        ...
        "chieucao":heightController.value.text,
        "cannang": weightController.value.text
      }
    });
