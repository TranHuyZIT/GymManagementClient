...
class _CustomerStatsState extends State<CustomerStats> {
  ...
  getStat(DateTime? ngaybd, DateTime? ngaykt) async{
    ...
    var jsonResponse = await LogService.getCustomerStats(queries: queries);
    ...
    return  Column(
      children: [
        Row(
          ...
          children:  [
            Expanded(child: Container(margin: const EdgeInsets.fromLTRB(0, 0, 0, 20),child: Center(child: Text("Thống kê người tập", style: TextStyle(fontSize: 25),))))
          ],
        ),
        Row(
          children: [
